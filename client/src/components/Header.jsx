      ...
      <nav className="flex items-center gap-2">
        ...
        >
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <div
              className="text-orange-300 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-900 transition-colors rounded-lg"
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <div
              className="text-orange-500 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-900 transition-colors rounded-lg"
