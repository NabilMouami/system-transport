...
function ListUsers() {
    ...
    const columns = [
  ...
  
        {
          ...
          renderCell: (params) => {
            return (
              <>
                <button className="collabListEdit" onClick={()=> details(params.row)}>Chnager</button>
                <RiChatDeleteFill
  ...
  return (
    <div className="collabList">
      <Link to="/ajoute-user">
       <button className="addnewCollab"><span className="text-xl mr-5">+</span>Ajouter un Utilisateur</button>
      </Link>
    <Box
      sx={{
        height: 600,
